...
import { addAttendMeetup, getDetailMeetup, getMemberMeetup } from './actions';

import { createStructuredSelector } from 'reselect';
import { selectMeetupDetail, selectMemberMeetup } from './selector';

const DetailMeetup = ({ meetupDetail, meetupMember }) => {
  ...
  const addAttend = async (id) => {
    try {
      await dispatch(addAttendMeetup(parseInt(id, 10)));
      const memberMeetup = await dispatch(getMemberMeetup(id));
      // Lakukan sesuatu dengan memberMeetup
      console.log(memberMeetup);
    } catch (error) {
      // Tangani kesalahan
        ...
        <div className={classes.content}>
          <div className={classes.kiri}>
            ...
            <div className={classes.member}>
              ...
              {!meetupMember ? (
                <p className={classes.membernotfound}>Member masih kosong</p>
              ) : (
