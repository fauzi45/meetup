...
const ClientRoutes = () => {
  const getRoutes = () => {
    ...
    const renderElement = (route) => {
      const { layout: Layout, component: Component, protected: Protected, organizerOnly } = route;
      ...
      return Protected ? <Client organizerOnly={organizerOnly}>{element}</Client> : element;
    };
